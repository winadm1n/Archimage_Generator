...
with Diagram("architecture_diagram", show=False):
    ...
    urlretrieve(get_image_urls("icon of azure cloud functions in AZURE"), "/home/runner/work/Archimage_Generator/Archimage_Generator/temp_src_images/azure_cloud_functions_icon.png")
    azure_cloud_functions_ = Custom("azure cloud \nfunctions ", "/home/runner/work/Archimage_Generator/Archimage_Generator/temp_src_images/azure_cloud_functions_icon.png")
